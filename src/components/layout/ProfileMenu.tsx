...
import { LogOut, BarChart3, ChevronDown, Settings, LayoutDashboard } from "lucide-react";
        ...
        {open && (
          ...
          >
            ...
            <div className="p-2">
              {isAthlete && (
                <Link
                  href="/dashboards/athlete-dashboard"
                ...
                >
                  <LayoutDashboard size={17} className="text-text-muted" />
                  Dashboard
                </Link>
              )}
              <Link
